...
name="default"
x=[/*Middletown*/896,/*Erie*/154,/*Edinboro*/143,/*Meadville*/135,
   /*Hermitage*/65,/*Grove City*/146,/*New Castle*/85,/*Cranberry Twp*/139,
   /*Pittsburgh*/160,/*Monroeville*/208,/*West Mifflin*/190,/*Greensburg*/264,
   /*Seven Springs*/319,/*Somerset*/368,/*Johnstown*/405,/*Indiana*/353,
   /*Punxsutawney*/396,/*Brookville*/372,/*Clarion*/303,/*Warren*/362,
   /*Bradford*/473,/*St Marys*/492,/*DuBois*/445,/*Clearfield*/517,
   /*Coudersport*/613,/*State College*/649,/*Altoona*/525,/*Hollidaysburg*/527,
   /*Huntington*/614,/*Wellsboro*/774,/*Mansfield*/825,/*Sayre*/949,
   /*Lock Haven*/743,/*Montoursville*/863,/*Williamsport*/844,/*Lewisburg*/871,
   /*Bloomsburg*/967,/*Harrisburg*/872,/*Carlisle*/798,/*Chambersburg*/694,
   /*Hanover*/851,/*York*/908,/*Hershey*/925,/*Lancaster*/1005,
   /*Lebanon*/980,/*Reading*/1091,/*Wilkes-Barre*/1096,/*Scranton*/1143,
   /*Allentown*/1193,/*Easton*/1249,/*King of Prussia*/1217,/*Philadelphia*/1268];

y=[/*Middletown*/622/*Erie*/,40/*Edinboro*/,117/*Meadville*/,187
   /*Hermitage*/,307/*Grove City*/,330/*New Castle*/,377/*Cranberry Twp*/,474
   /*Pittsburgh*/,548/*Monroeville*/,555/*West Mifflin*/,573/*Greensburg*/,591
   /*Seven Springs*/,678/*Somerset*/,683/*Johnstown*/,587/*Indiana*/,498
   /*Punxsutawney*/,402/*Brookville*/,336/*Clarion*/,320/*Warren*/,132
   /*Bradford*/,98/*St Marys*/,259/*DuBois*/,349/*Clearfield*/,378
   /*Coudersport*/,155/*State College*/,448/*Altoona*/,530/*Hollidaysburg*/,558
   /*Huntington*/,543/*Wellsboro*/,161/*Mansfield*/,144/*Sayre*/,90
   /*Lock Haven*/,347/*Montoursville*/,311/*Williamsport*/,313/*Lewisburg*/,397
   /*Bloomsburg*/,384/*Harrisburg*/,603/*Carlisle*/,628/*Chambersburg*/,707
   /*Hanover*/,747/*York*/,697/*Hershey*/,600/*Lancaster*/,673
   /*Lebanon*/,583/*Reading*/,582/*Wilkes-Barre*/,310/*Scranton*/,260
   /*Allentown*/,500/*Easton*/,474/*King of Prussia*/,651/*Philadelphia*/,694];

var currentTour=[0,10,20,30,40,50,
                 1,11,21,31,41,51,
                 2,12,22,32,42,
                 3,13,23,33,43,
                 4,14,24,34,44,
...
function drawTour(idsInOrder) {
  ...
  img.onload = function(){
	...
	for (var i = 1; i < idsInOrder.length; i++) {
		...
		ctx.stroke();
		dist = dist + Math.sqrt(Math.pow(x[ndx]-lastX,2)+Math.pow(y[ndx]-lastY,2))
		lastX = x[ndx]
		lastY = y[ndx]
	}
	ctx.lineTo(x[idsInOrder[0]]/SCALE,y[idsInOrder[0]]/SCALE);
	ctx.stroke();		
	dist = dist + Math.sqrt(Math.pow(x[idsInOrder[0]]-lastX,2)+Math.pow(y[idsInOrder[0]]-lastY,2))
